export type Duration = "weekly" | "monthly";

export type Category = "all" | "plans" | "bowls" | "custom";
...
export type MenuItem = MealPlan | SignatureBowl;
...
export const mealPlans: MealPlan[] = [
  ...
  },
  {
    ...
    carbs: "115g",
    fat: "54g",
    ingredients: ["Breakfast Bowl", "Lunch Bowl", "Dinner Bowl", "Daily Juice Boost"],
...
export const customOptions: CustomIngredient[] = [
  // Bases
  { id: "b1", name: "Baby Spinach & Romaine Mix", price: 6000, category: "base" },
  ...
  { id: "p2", name: "Marinated Steak Strips", price: 15000, category: "protein" },
  { id: "p3", name: "Pan-Seared Salmon Fillet", price: 20000, category: "protein" },
  { id: "p4", name: "Boiled Eggs (2x)", price: 4000, category: "protein" },
  { id: "p5", name: "Grilled Halloumi Cheese", price: 10000, category: "protein" },
  ...
  { id: "t4", name: "Roasted Plantain Cubes", price: 3000, category: "topping" },
  ...
  { id: "d2", name: "Zesty Citrus Vinaigrette", price: 2000, category: "dressing" },
