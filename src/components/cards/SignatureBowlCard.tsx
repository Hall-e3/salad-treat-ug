...
import { formatUGX, type SignatureBowl } from "@/lib/menu-data";
...
interface SignatureBowlCardProps {
  item: SignatureBowl;
  onOpenModal: () => void;
}

export default function SignatureBowlCard({ item, onOpenModal }: SignatureBowlCardProps) {
      ...
      <div className="w-full min-w-0">
        ...
        >
          ...
          <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
            <Chip label="Signature Bowl" variant="overlay" />
            {item.featured && (
